...
var SurveyManager = /** @class */ (function () {
    function SurveyManager(posthog) {
        ...
        this.callSurveysAndEvaluateDisplayLogic = function (forceReload) {
            ...
            _this.getActiveMatchingSurveys(function (surveys) {
                ...
                inAppSurveysQueue.forEach(function (survey) {
                    ...
                    if ((0, type_utils_1.isNull)(_this._surveyInFocus) && survey.type === posthog_surveys_types_1.SurveyType.Popover) {
        ...
        this._addSurveyToFocus = function (survey) {
            if (!(0, type_utils_1.isNull)(_this._surveyInFocus)) {
    ...
    SurveyManager.prototype._isSurveyFeatureFlagEnabled = function (flagKey) {
        if (!flagKey) {
            return true;
        }
    ...
    SurveyManager.prototype.checkSurveyEligibility = function (survey) {
        ...
        if (!(0, surveys_extension_utils_1.hasWaitPeriodPassed)((_a = survey.conditions) === null || _a === void 0 ? void 0 : _a.seenSurveyWaitPeriodInDays)) {
            eligibility.eligible = false;
...
function Questions(_a) {
    ...
    // Sync preview state
    (0, hooks_1.useEffect)(function () {
        if (isPreviewMode && !(0, type_utils_1.isUndefined)(previewPageIndex)) {
