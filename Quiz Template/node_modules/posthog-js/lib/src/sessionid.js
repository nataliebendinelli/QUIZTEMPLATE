...
var SessionIdManager = /** @class */ (function () {
    function SessionIdManager(instance, sessionIdGenerator, windowIdGenerator) {
        ...
        this._sessionTimeoutMs =
            (0, number_utils_1.clampToRange)(desiredTimeout, MIN_SESSION_IDLE_TIMEOUT_SECONDS, exports.MAX_SESSION_IDLE_TIMEOUT_SECONDS, 'session_idle_timeout_seconds', exports.DEFAULT_SESSION_IDLE_TIMEOUT_SECONDS) * 1000;
    ...
    SessionIdManager.prototype.onSessionId = function (callback) {
        ...
        if ((0, type_utils_1.isUndefined)(this._sessionIdChangedHandlers)) {
            this._sessionIdChangedHandlers = [];
        }
    ...
    SessionIdManager.prototype._getSessionId = function () {
        ...
        if ((0, type_utils_1.isArray)(sessionIdInfo) && sessionIdInfo.length === 2) {
    ...
    SessionIdManager.prototype.checkAndGetSessionAndWindowId = function (readOnly, _timestamp) {
        ...
        var sessionPastMaximumLength = (0, type_utils_1.isNumber)(startTimestamp) &&
            startTimestamp > 0 &&
