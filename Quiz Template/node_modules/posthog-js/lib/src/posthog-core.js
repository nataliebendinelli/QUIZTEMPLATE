...
var defaultConfig = function (defaults) {
    ...
    return ({
        ...
        debug: (globals_1.location && (0, type_utils_1.isString)(globals_1.location === null || globals_1.location === void 0 ? void 0 : globals_1.location.search) && globals_1.location.search.indexOf('__posthog_debug=true') !== -1) || false,
...
var configRenames = function (origConfig) {
    var renames = {};
    if (!(0, type_utils_1.isUndefined)(origConfig.process_person)) {
        renames.person_profiles = origConfig.process_person;
    }
    if (!(0, type_utils_1.isUndefined)(origConfig.xhr_headers)) {
        renames.request_headers = origConfig.xhr_headers;
    }
    if (!(0, type_utils_1.isUndefined)(origConfig.cookie_name)) {
        renames.persistence_name = origConfig.cookie_name;
    }
    if (!(0, type_utils_1.isUndefined)(origConfig.disable_cookie)) {
        renames.disable_persistence = origConfig.disable_cookie;
    }
    if (!(0, type_utils_1.isUndefined)(origConfig.store_google)) {
        renames.save_campaign_params = origConfig.store_google;
    }
    if (!(0, type_utils_1.isUndefined)(origConfig.verbose)) {
    ...
    if ((0, type_utils_1.isArray)(origConfig.property_blacklist)) {
        if ((0, type_utils_1.isUndefined)(origConfig.property_denylist)) {
            newConfig.property_denylist = origConfig.property_blacklist;
        }
        else if ((0, type_utils_1.isArray)(origConfig.property_denylist)) {
...
var PostHog = /** @class */ (function () {
    function PostHog() {
        ...
        this.people = {
            set: function (prop, to, callback) {
                var _a;
                var setProps = (0, type_utils_1.isString)(prop) ? (_a = {}, _a[prop] = to, _a) : prop;
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        if ((0, type_utils_1.isUndefined)(token) || (0, type_utils_1.isEmptyString)(token)) {
        ...
        if ((0, type_utils_1.isFunction)(this.config._onCapture) && this.config._onCapture !== __NOOP) {
    ...
    PostHog.prototype._onRemoteConfig = function (config) {
        ...
        if (config.supportedCompression && !this.config.disable_compression) {
            this.compression = (0, string_utils_1.includes)(config['supportedCompression'], types_1.Compression.GZipJS)
                ? types_1.Compression.GZipJS
                : (0, string_utils_1.includes)(config['supportedCompression'], types_1.Compression.Base64)
    ...
    PostHog.prototype._execute_array = function (array) {
        ...
        (0, utils_1.eachArray)(array, function (item) {
            if (item) {
                fn_name = item[0];
                if ((0, type_utils_1.isArray)(fn_name)) {
                    capturing_calls.push(item); // chained call e.g. posthog.get_group().set()
                }
                else if ((0, type_utils_1.isFunction)(item)) {
                    ;
                    item.call(_this);
                }
                else if ((0, type_utils_1.isArray)(item) && fn_name === 'alias') {
                    alias_calls.push(item);
                }
                else if ((0, type_utils_1.isArray)(item) && fn_name.indexOf('capture') !== -1 && (0, type_utils_1.isFunction)(_this[fn_name])) {
        ...
        var execute = function (calls, thisArg) {
            (0, utils_1.eachArray)(calls, function (item) {
                if ((0, type_utils_1.isArray)(item[0])) {
                    // chained call
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        if ((0, type_utils_1.isUndefined)(event_name) || !(0, type_utils_1.isString)(event_name)) {
        ...
        if ((properties === null || properties === void 0 ? void 0 : properties.$current_url) && !(0, type_utils_1.isString)(properties === null || properties === void 0 ? void 0 : properties.$current_url)) {
        ...
        if (!(0, type_utils_1.isUndefined)(options === null || options === void 0 ? void 0 : options.timestamp)) {
        ...
        if (event_name === posthog_surveys_types_1.SurveyEventName.DISMISSED || event_name === posthog_surveys_types_1.SurveyEventName.SENT) {
            ...
            localStorage.setItem((0, survey_utils_1.getSurveySeenKey)({ id: surveyId, current_iteration: surveyIteration }), 'true');
        ...
        if (!(0, type_utils_1.isEmptyObject)(finalSet)) {
            this.setPersonPropertiesForFlags(finalSet);
        }
        if (!(0, type_utils_1.isNullish)(this.config.before_send)) {
    ...
    PostHog.prototype.calculateEventProperties = function (eventName, eventProperties, timestamp, uuid, readOnly) {
        ...
        if (eventName === '$snapshot') {
            ...
            !((0, type_utils_1.isString)(properties['distinct_id']) || (0, type_utils_1.isNumber)(properties['distinct_id'])) ||
                (0, type_utils_1.isEmptyString)(properties['distinct_id'])) {
        ...
        if (!(0, type_utils_1.isUndefined)(startTimestamp)) {
        ...
        if ((0, type_utils_1.isArray)(this.config.property_denylist)) {
    ...
    PostHog.prototype._calculate_set_once_properties = function (dataSetOnce) {
        ...
        if ((0, type_utils_1.isEmptyObject)(setOnceProperties)) {
            return undefined;
        }
    ...
    PostHog.prototype.identify = function (new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
        ...
        if ((0, type_utils_1.isNumber)(new_distinct_id)) {
        ...
        if ((0, string_utils_1.isDistinctIdStringLike)(new_distinct_id)) {
    ...
    PostHog.prototype.alias = function (alias, original) {
        ...
        if ((0, type_utils_1.isUndefined)(original)) {
    ...
    PostHog.prototype.set_config = function (config) {
        ...
        if ((0, type_utils_1.isObject)(config)) {
    ...
    PostHog.prototype.captureException = function (error, additionalProperties) {
        ...
        return this.exceptions.sendExceptionEvent(__assign(__assign({}, (0, error_conversion_1.errorToProperties)((0, type_utils_1.isError)(error) ? { error: error, event: error.message } : { event: error }, 
    ...
    PostHog.prototype._hasPersonProcessing = function () {
        ...
        return !(this.config.person_profiles === 'never' ||
            (this.config.person_profiles === 'identified_only' &&
                !this._isIdentified() &&
                (0, type_utils_1.isEmptyObject)(this.getGroups()) &&
    ...
    PostHog.prototype.opt_in_capturing = function (options) {
        ...
        if ((0, type_utils_1.isUndefined)(options === null || options === void 0 ? void 0 : options.captureEventName) || (options === null || options === void 0 ? void 0 : options.captureEventName)) {
    ...
    PostHog.prototype._runBeforeSend = function (data) {
        ...
        var fns = (0, type_utils_1.isArray)(this.config.before_send) ? this.config.before_send : [this.config.before_send];
        ...
        try {
            for (var fns_1 = __values(fns), fns_1_1 = fns_1.next(); !fns_1_1.done; fns_1_1 = fns_1.next()) {
                ...
                if ((0, type_utils_1.isNullish)(beforeSendResult)) {
                    var logMessage = "Event '".concat(data.event, "' was rejected in beforeSend function");
                    if ((0, type_utils_1.isKnownUnsafeEditableEvent)(data.event)) {
                ...
                if (!beforeSendResult.properties || (0, type_utils_1.isEmptyObject)(beforeSendResult.properties)) {
...
function init_from_snippet() {
    ...
    if (snippetPostHog) {
        ...
        (0, utils_1.each)(snippetPostHog['_i'], function (item) {
            if (item && (0, type_utils_1.isArray)(item)) {
